...
Rapidly create and share micro-schedules, each with their own 'edit' and 'view only' link. Load any number of independent schedules for real time coordination without signins.
